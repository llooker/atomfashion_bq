view: session_purchase_facts {
  derived_table: {
    ...
    from (
      ...
      FROM looker-private-demo.events
      JOIN looker-private-demo.order_items on order_items.created_at = events.created_at
      --JOIN looker-private-demo.inventory_items  AS inventory_items ON inventory_items.id = order_items.inventory_item_id
